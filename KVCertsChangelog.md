...
and
[samples](https://github.com/Azure/azure-sdk-for-java/tree/master/keyvault/client/certificates/src/samples/java)
...
- Authentication using `azure-identity` credentials
  - see this package's
  [documentation](https://github.com/Azure/azure-sdk-for-java/tree/master/keyvault/client/certificates/README.md)
  , and the
